...
* Improve deep-scan coverage, resource throttling, stalled-run recovery, and signature error reporting.
* Add WP-Cron schedule monitoring and execution history under Security.
